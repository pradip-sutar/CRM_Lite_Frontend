...
export const getEnquiryReport = async (from_date, to_date, customer_instance, assigned_employee,source) => {
  try {
  ...
  params.append("page",1)
    ...
    if (assigned_employee) params.append("assigned_employee", assigned_employee);
