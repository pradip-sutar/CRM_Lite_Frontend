...
const Expectation = () => {
  ...
  useEffect(() => {
    if (
      getexpectations ||
      (getexpectations.persona_expectations?.personas &&
        ...
        personas: personas?.map((persona, index) => {
          ...
          return {
            ...
            subcatagory: persona.personasubCategory.map((sub, subIndex) => {
              const matchingSub =
                matchingPersona?.subcatagory?.[subIndex] || {};
              return {
                name: sub || "",
  ...
  return (
    ...
    >
      ...
      <div className=" col-sm ml-2 mb-2">
        <FormControl
          ...
          <>
            ...
            >
              <table className="table table-bordered">
                ...
                <tbody>
                  {getexpectations.persona_expectations?.personas?.map(
                    (persona, index) => (
                      <React.Fragment key={`${getexpectations.id}-${index}`}>
                        {persona.subcatagory.map((sub, subIndex) => (
                          <tr
                            key={`${getexpectations.id}-${index}-${subIndex}`}
                          >
                            {subIndex === 0 && (
                              <>
