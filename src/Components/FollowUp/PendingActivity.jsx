...
const PendingActivity = ({ filterUrl, filterData, activeTab }) => {
  ...
  const handelFetchData = async () => {
    ...
    if (!(followupCategory == "pending")) {
      url = `/api/enquiry_table_handler/?followup_category=pending`;
    } else {
      url = filterUrl;
    }
                    ...
                    >
                          ...
                          <Box>
                            ...
                            <Typography
                              sx={{
                                ...
                                textWrap: {
                                  md: "wrap",
                                  "@media (max-width: 769px)": "wrap",
                                  xs: "nowrap",
                                  "@media (max-width: 426px)": "nowrap",
                                },
                              }}
                            >
                              {data?.customer_name}
                      ...
                      <Grid item xs={3}>
                        <Box sx={{ display: "flex", alignItems: "start" }}>
                          ...
                          <Box>
                            <Typography
                              sx={{ fontSize: "0.7rem", textWrap: "nowrap" }}
                            >
