    ...
    if (response?.data?.length === 1) {
      ...
      if (nextDateTime) {
        ...
        if (nextDate < today) {
          ...
          setFilterUrl(
            `/api/enquiry_table_handler/?page=1&customer_phone=${mobileSearchBarValue}&followup_category=pending`
          );
          setContent("pending");
          ...
          setFilterUrl(
            `/api/enquiry_table_handler/?page=1&customer_phone=${mobileSearchBarValue}&followup_category=upcoming`
          );
          setContent("upcoming");
          ...
          setFilterUrl(
            `/api/enquiry_table_handler/?page=1&customer_phone=${mobileSearchBarValue}&followup_category=today`
          );
          setContent("today");
          setActiveTab("today");
      ...
      if (response?.data?.[0]?.latest_action == "No status found") {
        ...
        setFilterUrl(
          `/api/enquiry_table_handler/?page=1&customer_phone=${mobileSearchBarValue}&followup_category=new`
        );
        setContent("new");
        setActiveTab("new");
      }
